...
$PAGE->navbar->add(get_string('manager_categories', 'block_video_manager'));
$PAGE->set_url('/blocks/video_manager/manager_categories.php',$params);
$PAGE->set_context($syscontext);
$PAGE->set_pagelayout('standard');
$PAGE->set_heading(get_string('manager_categories', 'block_video_manager'));
...
echo html_writer::link(new moodle_url('/blocks/video_manager/category.php'),'Adicionar Categoria');

$cats = $class->get_categories();

$page = new \block_video_manager\output\list_categories_page($cats);
echo $output->box($output->render($page));
